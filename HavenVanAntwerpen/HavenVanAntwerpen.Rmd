...
Mijn paper gaat over het oplossen volgend probleem door middel van machine learning. 
...
```{r }
data <- read.csv("~/GitHub/Artificial-Intelligence-Project/HavenVanAntwerpen/DataShipPositions.csv")
...
Elke deel van de RNN laag zal een gps reading outputten, en die output wordt gebruikt voor de volgende laag.
...
## packages: dlm, KFAS, MARSS, astsa, KFKSDS

##koers, snelheid en positie van een voertuig kunnen worden gebruikt om een toekomstige positie te voorspellen.
