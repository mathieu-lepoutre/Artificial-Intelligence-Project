...
```{r }
ship_data <- fread("schipdriecsv.csv")
...
ship_data[,AISTrajectPositionTimeStamp:= AISTrajectPositionTimeStamp %>% as.POSIXct]

ship_data[,AISTrajectPositionTimeStamp_num:= AISTrajectPositionTimeStamp %>% as.numeric]
ship_data <- ship_data[AISTrajectPositionTimeStamp %>% order]
ship_data$AISTrajectPositionTimeStamp %>% plot
ship_data <- data[1:200,]
ship_data
count(ship_data)
