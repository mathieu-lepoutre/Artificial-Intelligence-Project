...
You have to ask yourself these question, "why is the time difference between two registries sometimes a big difference ?" and  "When would an owner 
stop the beacon from sending location data ?"

The answer is if the owner is sleeping or when the ship is docked. This makes the data inaccurate. That's why I first split the dataset on a timedelta. 
