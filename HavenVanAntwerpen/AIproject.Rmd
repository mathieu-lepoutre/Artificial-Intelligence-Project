...
Through nnet and KNN it was possible to accurately predict a ship's destination positioning by training the model on past trajectories.
The time delta prediction was not as accurate. I believe this is because there's a lot more variables in play when accurately predicting the time.
