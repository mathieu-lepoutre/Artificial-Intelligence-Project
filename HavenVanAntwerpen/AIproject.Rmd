...
Disclaimer; Please compile the first part of this process through the "notebook.ipynb" file, in a visual studio code environment. I put the code here for readability, but the python code will not compile correctly in an R studio environment.
